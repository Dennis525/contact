...
public class Main {
    ...
    private static void sendNewMessage() {
        System.out.println("Sending message to who?:");
        String name = scanner.next();
        if (name.equals("")){
            System.out.println("You have entered nothing.Please enter the name of the contact again");
            sendNewMessage();
        }else {
            ...
            if (doesExist){
                ...
                if (text.equals("")){
                    System.out.println("You have entered nothing.Please enter some message");
                    sendNewMessage();
                }else {
                    id++;
    ...
    private static void deleteContact() {
        ...
        String name = scanner.next();
        if (name.equals("")){
            System.out.println("You have entered nothing. Please enter the name again");
            deleteContact();
        }else {
            boolean doesExist = false;
            for (Contact c: contacts){
    ...
    private static void addNewContact() {
        ...
        if(name.equals("") || number.equals("") || email.equals("")){
            ...
            if (doesExist){
                System.out.println("We have a contact named "+ name + "saved on your contacts");
                addNewContact();
            }else {
